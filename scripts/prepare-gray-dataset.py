...
gray_path=os.path.join(processed_path,gray_dir)
try:
    os.mkdir(gray_path)
...
processed_train_path=os.path.join(gray_path,train_dir)
processed_test_path=os.path.join(gray_path,test_dir)
...
for item in os.listdir('../data/raw/train'):
    parent_dir="../data/processed/Gray/train"
...
for item in os.listdir('../data/raw/test'):
    parent_dir="../data/processed/Gray/test"
    path=os.path.join(parent_dir,item)
    try:
        os.mkdir(path)
