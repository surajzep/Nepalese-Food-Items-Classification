...
def augment_images_train(start_load_index,start_save_index):
    ...
    for item in (os.listdir("../data/processed/RGB/train")):
        ...
        for load_index in range(start_load_index,start_save_index):
            ...
            try:
                ...
                image=imageio.imread("../data/processed/RGB/train/"+item+"/item"+str(load_index)+".jpg")
                rotated_images=rotate(image)
                cropped_flipped_blurred=crop_flip_blur(image)
                
            except: 
                print("../data/processed/RGB/train/"+item+"/item"+str(load_index)+".jpg could not be read!")
            
            
            for rotated_image in rotated_images:
                
                
                imageio.imwrite(("../data/processed/RGB/train/"+item+"/item"+str(save_index)+".jpg"),rotated_image )
            ...
            for cropped_flipped_blurred_image in cropped_flipped_blurred:
                ...
                imageio.imwrite(("../data/processed/RGB/train/"+item+"/item"+str(save_index)+".jpg"),
...
def augment_images_test(start_load_index,start_save_index):
    ...
    for item in (os.listdir("../data/processed/RGB/test")):
        save_index=start_save_index
        ...
        for load_index in range(start_load_index,start_save_index):
            ...
            try:
                ...
                image=imageio.imread("../data/processed/RGB/test/"+item+"/item"+str(load_index)+".jpg")
                rotated_images=rotate(image)
                cropped_flipped_blurred=crop_flip_blur(image)
                
            except: 
                print("../data/processed/RGB/test/"+item+"/item"+str(load_index)+".jpg could not be read!")
            
            
            for rotated_image in rotated_images:
                
                
                imageio.imwrite(("../data/processed/RGB/test/"+item+"/item"+str(save_index)+".jpg"),rotated_image )
                save_index=save_index+1
            ...
            for cropped_flipped_blurred_image in cropped_flipped_blurred:
                ...
                saving_filename="item"+str(save_index)+".jpg"
                imageio.imwrite(("../data/processed/RGB/test/"+item+"/item"+str(save_index)+".jpg"),
                                cropped_flipped_blurred_image )
                save_index=save_index+1    
